#ifndef GAMERULESMODEL_H
#define GAMERULESMODEL_H
...
public:
    ...
    GameRulesModel(std::size_t numero_de_jogadores,
    ...
    //compara as cartas
    virtual int compara(CardModel c1, CardModel c2, CardModel c3);
